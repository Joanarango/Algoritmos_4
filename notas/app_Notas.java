...
public class app_Notas {
        ...
        if (swBln == false) {
            ...
            JOptionPane.showMessageDialog(null,
                    "NOMBRE: " + estudiantes.get(posicionInt).getNombreStr() + "\nCONTACTO: "
                            + estudiantes.get(posicionInt).getContactoStr() + "\nCORREO: "
                            + estudiantes.get(posicionInt).getCorreoStr() + "\nPROGRAMA: "
                            + estudiantes.get(posicionInt).getProgramaStr() + "\nSEMESTRE: " +
    ...
    private static void fnt_moduloestudiantes(boolean m1) {
        ...
        while (m1 == true) {
            ...
            switch (op1) {
                ...
                default:
                    JOptionPane.showMessageDialog(null, "SELECCION UNA OPCION VALIDA");
                    break;
            }
    ...
    private static void fnt_registrar_modulonotas() {
        ...
        JOptionPane.showMessageDialog(null, "NOTA REGISTRADA CON EXITOSAMENTE");
        ...
        if (swBln == false) {
            ...
            for (int i = 0; i < notas.size(); i++) {
                if (notas.get(i).getId_estudianteStr().equals(id)) {
                    JOptionPane.showMessageDialog(null,
                            "FECHA DE REGISTRO: " + notas.get(i).getFechaStr() +
    ...
    private static void fnt_modulonotas(boolean m2) {
        ...
        while (m2 == true) {
            String op2 = JOptionPane.showInputDialog(null, "MODULO NOTAS\n1. REGISTRAR\n2. REPORTE\n3. SALIR");
            switch (op2) {
                case "1":
